...
sudo docker run -d --restart always --name=www9 -p 8009:80 bf:v1
sudo docker run -d --restart always --name=www10 -p 8010:80 bf:v1
sudo docker run -d --restart always --name=www11 -p 8011:80 bf:v1
